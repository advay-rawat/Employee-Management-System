...
with open("/home/hdoop/notebooks/capstone-project/vocab/vocab.json") as f:
    vocab = set(json.load(f))
with open("/home/hdoop/notebooks/capstone-project/marked_words/marked_word.json") as f:
...
query = kafka_df.writeStream \
    ...
    .outputMode("update") \
    .option("checkpointLocation", "file:///home/hdoop/notebooks/capstone-project/checkpoint/") \
